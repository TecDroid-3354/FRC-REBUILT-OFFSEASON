...
package frc.tecdroid3354.utils.simulation;
...
/** Alternative to MapleSim FUEL simulation. It's necessary because MapleSim doesn't take Drag Force into account,
 * and it assumes Gravity as 11ms^-2 to "compensate" for that. In this file you have full control over the simulation */
    ...
    public void launchFuel(LinearVelocity launchVelocity, Angle hoodAngle, Angle turretYaw, Distance launchHeight) {
        ...
        Pose3d launchPose = new Pose3d(this.robotPoseSupplier.get())
                .plus(new Transform3d(new Translation3d(
                        RobotTransformations.INSTANCE.getROBOT_TO_SHOOTER().getMeasureX(),
                        RobotTransformations.INSTANCE.getROBOT_TO_SHOOTER().getMeasureY(),
                        launchHeight), RobotTransformations.INSTANCE.getROBOT_TO_SHOOTER().getRotation()));
