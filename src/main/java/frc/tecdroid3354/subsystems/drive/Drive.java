...
public class Drive extends SubsystemBase implements Vision.VisionConsumer {
    ...
    private static final RobotConfig PP_CONFIG = new RobotConfig(
            RobotPhysics.INSTANCE.getRobotMass(),
            RobotPhysics.INSTANCE.getRobotMOI(),
            new ModuleConfig(
                    SwerveTunerConstants.FrontLeft.WheelRadius,
                    SwerveTunerConstants.kSpeedAt12Volts.in(MetersPerSecond),
                    RobotPhysics.WHEEL_COF,
                    DCMotor.getKrakenX60Foc(1).withReduction(SwerveTunerConstants.FrontLeft.DriveMotorGearRatio),
    ...
    public static DriveTrainSimulationConfig getMapleSimConfig() {
        ...
        return mapleSimConfig = DriveTrainSimulationConfig.Default()
                .withRobotMass(RobotPhysics.INSTANCE.getRobotMass())
                .withCustomModuleTranslations(getModuleTranslations())
                .withGyro(COTS.ofPigeon2())
                .withSwerveModule(new SwerveModuleSimulationConfig(
                        DCMotor.getKrakenX60Foc(1),
                        DCMotor.getKrakenX60Foc(1),
                        SwerveTunerConstants.FrontLeft.DriveMotorGearRatio,
                        SwerveTunerConstants.FrontLeft.SteerMotorGearRatio,
                        Volts.of(SwerveTunerConstants.FrontLeft.DriveFrictionVoltage),
                        Volts.of(SwerveTunerConstants.FrontLeft.SteerFrictionVoltage),
                        Inches.of(2),
                        KilogramSquareMeters.of(SwerveTunerConstants.FrontLeft.SteerInertia),
                        RobotPhysics.WHEEL_COF));
    }
