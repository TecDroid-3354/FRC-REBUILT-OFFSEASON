...
public class PhoenixOdometryThread extends Thread {
    ...
    private static boolean isCANFD = new CANBus(SwerveTunerConstants.DrivetrainConstants.CANBusName).isNetworkFD();
        ...
        while (true) {
            ...
            try {
                if (isCANFD && phoenixSignals.length > 0) {
                    BaseStatusSignal.waitForAll(0.008, phoenixSignals);
                } else {
