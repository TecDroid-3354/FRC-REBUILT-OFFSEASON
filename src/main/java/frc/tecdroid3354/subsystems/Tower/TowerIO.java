 ...
 * Duplicate the motor-related fields inside {@link TowerIOInputs} for the number of motors in your subsystem,
 ...
 *  </p>
 *  <p>
 *  - When using kapt to generate classes, we have to mark every field of the {@link TowerIOInputs}
...
public interface TowerIO {
     ...
     *
     *  <p>
     *      If you are having trouble with your generated {@link TowerIOInputsAutoLogged}, it is most probably
    ...
    class TowerIOInputs {
        ...
        public MutAngularVelocity towerActualVelocity = DegreesPerSecond.mutable(0.0);
        public MutAngularVelocity towerTargetVelocity = DegreesPerSecond.mutable(0.0);
        public MutAngularVelocity towerManualTargetVelocity = DegreesPerSecond.mutable(0.0);
        public MutAngularVelocity towerPresetVelocity = DegreesPerSecond.mutable(0.0); // If applicable
    }

    /**
     * Intended to update any relevant fields in {@link TowerIOInputs}.
     * Might change depending on the implementation (i.e. simulation does not need to check motors' connectivity).
     * @param inputs The generated {@link TowerIOInputs} object keeping track of everything.
     */
    void updateTowerInputs(TowerIOInputs inputs,
     ...
     * @param newTowerManualVelocity Obtained live through Elastic.
     */
    void updateTowerManualVelocity(AngularVelocity newTowerManualVelocity);
     ...
     */
    void updateTowerMotorsControlGains(int slot);
     ...
     * @see #updateTowerManualVelocity(AngularVelocity)
     * @return A {@link Runnable} setting the subsystem manual target velocity
     */
    Runnable enableTowerManualVelocity();
     ...
     */
    Runnable enableTowerPresetVelocity();
     ...
     */
    Runnable brakeTowerMotors();

    /**
     * Applies the configuration inside {@link TowerConstants.PhoenixMotorConfiguration}. Follower commands are included.
     */
     ...
     * </p>
     */
    class DummyTowerIO implements TowerIO {

        @Override
        public void updateTowerInputs(TowerIOInputs inputs,
                                      MotorIO.MotorIOInputs leadMotorInputs, MotorIO.MotorIOInputs followerMotorInputs) {

        }

        @Override
        public void updateTowerManualVelocity(AngularVelocity newTowerManualVelocity) {

        }

        @Override
        public void updateTowerMotorsControlGains(int slot) {

        }

        @Override
        public Runnable enableTowerManualVelocity() {
            return null;
        }

        @Override
        public Runnable enableTowerPresetVelocity() {
            return null;
        }

        @Override
        public Runnable stopTower() {
            return null;
        }

        @Override
        public Runnable coastTowerMotors() {
            return null;
        }

        @Override
        public Runnable brakeTowerMotors() {
            return null;
        }
