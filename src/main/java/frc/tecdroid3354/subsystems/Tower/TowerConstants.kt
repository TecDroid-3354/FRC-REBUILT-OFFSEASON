...
object TowerConstants {
    /**
     * Contains the ID Of any hardware related to the subsystem and the CANBUS it is on
     */
    object Identification {
        const val TOWER_CANBUS_NAME: String = CanBuses.RIO_CANBUS
        const val LEAD_MOTOR_ID: Int = 44
        const val FOLLOWER_MOTOR_ID: Int = 45
    }
     ...
     */
    object Mechanical {
        val REDUCTION: Reduction = Reduction(1.3)

        const val NUMBER_OF_MOTORS: Int = 2

        // From OnShape as of 26/08/2026
        private val MECHANISM_INERTIA: MomentOfInertia = (77.263881.times(SimConstants.FREEDOM_UNITS_TO_METRIC_MOI)).kilogramSquareMeters
    ...
    object PhoenixMotorConfiguration {
        ...
        val initialMotorsConfiguration: TalonFXConfiguration = KrakenMotors.createTalonFXConfiguration(
            ...
            Optional.of<Slot0Configs>(SubsystemsControlGains.TOWER_MOTOR_PRIMARY_GAINS.updatePhoenixSlot0Configs()),
            Optional.of<Slot1Configs>(SubsystemsControlGains.TOWER_MOTOR_PRIMARY_GAINS.updatePhoenixSlot1Configs()),
            Optional.of<Slot2Configs>(SubsystemsControlGains.TOWER_MOTOR_PRIMARY_GAINS.updatePhoenixSlot2Configs()),
            Optional.of<MotionMagicConfigs>(
                KrakenMotors.configureAngularMotionMagic(
                    SubsystemsMotionTargets.TOWER_MOTION_TARGETS,
     ...
     */
    object Telemetry {
        const val SUBSYSTEM_TAB                         : String = "Tower"
        ...
        const val LEAD_MOTOR_CONNECTION_ALERT_TAB       : String =
            "${RobotTelemetry.CONNECTION_ALERTS_TAB}/${Identification.TOWER_CANBUS_NAME}" +
