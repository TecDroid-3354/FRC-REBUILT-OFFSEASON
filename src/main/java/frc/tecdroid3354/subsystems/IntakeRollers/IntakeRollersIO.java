 ...
 * Duplicate the motor-related fields inside {@link IntakeRollersIOInputs} for the number of motors in your subsystem,
 ...
 *  </p>
 *  <p>
 *  - When using kapt to generate classes, we have to mark every field of the {@link IntakeRollersIOInputs}
...
public interface IntakeRollersIO {
     ...
     *
     *  <p>
     *      If you are having trouble with your generated {@link IntakeRollersIOInputsAutoLogged}, it is most probably
    ...
    class IntakeRollersIOInputs {
        ...
        public MutAngularVelocity intakeRollersActualVelocity = DegreesPerSecond.mutable(0.0);
        public MutAngularVelocity intakeRollersTargetVelocity = DegreesPerSecond.mutable(0.0);
        public MutAngularVelocity intakeRollersManualTargetVelocity = DegreesPerSecond.mutable(0.0);
        public MutAngularVelocity intakeRollersPresetVelocity = DegreesPerSecond.mutable(0.0); // If applicable
    }

    /**
     * Intended to update any relevant fields in {@link IntakeRollersIOInputs}.
     * Might change depending on the implementation (i.e. simulation does not need to check motors' connectivity).
     * @param inputs The generated {@link IntakeRollersIOInputs} object keeping track of everything.
     */
    void updateIntakeRollersInputs(IntakeRollersIOInputs inputs,
     ...
     * @param newIntakeRollersManualVelocity Obtained live through Elastic.
     */
    void updateIntakeRollersManualVelocity(AngularVelocity newIntakeRollersManualVelocity);
     ...
     */
    void updateIntakeRollersMotorsControlGains(int slot);
     ...
     * @see #updateIntakeRollersManualVelocity(AngularVelocity)
     * @return A {@link Runnable} setting the subsystem manual target velocity
     */
    Runnable enableIntakeRollersManualVelocity();
     ...
     */
    Runnable coastIntakeRollersMotors();
     ...
     */
    Runnable brakeIntakeRollersMotors();

    /**
     * Applies the configuration inside {@link IntakeRollersConstants.PhoenixMotorConfiguration}. Follower commands are included.
     */
     ...
     * </p>
     */
    class DummyIntakeRollersIO implements IntakeRollersIO {

        @Override
        public void updateIntakeRollersInputs(IntakeRollersIOInputs inputs,
                                              MotorIO.MotorIOInputs leadMotorInputs, MotorIO.MotorIOInputs followerMotorInputs) {

        }

        @Override
        public void updateIntakeRollersManualVelocity(AngularVelocity newIntakeRollersManualVelocity) {

        }

        @Override
        public void updateIntakeRollersMotorsControlGains(int slot) {

        }

        @Override
        public Runnable enableIntakeRollersManualVelocity() {
            return null;
        }
        ...
        @Override
        public Runnable stopIntakeRollers() {
            return null;
        }

        @Override
        public Runnable coastIntakeRollersMotors() {
            return null;
        }

        @Override
        public Runnable brakeIntakeRollersMotors() {
            return null;
        }
