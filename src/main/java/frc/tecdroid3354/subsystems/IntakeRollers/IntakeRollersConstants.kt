...
object IntakeRollersConstants {
    ...
    object PhoenixMotorConfiguration {
        ...
        val initialMotorsConfiguration: TalonFXConfiguration = KrakenMotors.createTalonFXConfiguration(
            ...
            Optional.of<Slot0Configs>(SubsystemsControlGains.INTAKE_ROLLERS_MOTOR_PRIMARY_GAINS.updatePhoenixSlot0Configs()),
            Optional.of<Slot1Configs>(SubsystemsControlGains.INTAKE_ROLLERS_MOTOR_PRIMARY_GAINS.updatePhoenixSlot1Configs()),
            Optional.of<Slot2Configs>(SubsystemsControlGains.INTAKE_ROLLERS_MOTOR_PRIMARY_GAINS.updatePhoenixSlot2Configs()),
            Optional.of<MotionMagicConfigs>(
                KrakenMotors.configureAngularMotionMagic(
                    SubsystemsMotionTargets.INTAKE_ROLLERS_MOTION_TARGETS,
     ...
     */
    object Telemetry {
        const val SUBSYSTEM_TAB                         : String = "Intake Rollers"
        ...
        const val LEAD_MOTOR_CONNECTION_ALERT_TAB       : String =
            "${RobotTelemetry.CONNECTION_ALERTS_TAB}/${Identification.INTAKE_ROLLERS_CANBUS_NAME}" +
